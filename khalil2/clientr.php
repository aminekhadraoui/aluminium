...
<table>
  ...
  <tr>
    ...
    <td><input type="text" id="fname" name="m1" placeholder="quantité"></td>
    
  </tr>
  <tr>
    <td><input type="text" id="fname" name="a2" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m2" placeholder="quantité"></td>
    
  </tr>
  <tr>
    <td><input type="text" id="fname" name="a3" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m3" placeholder="quantité"></td>
    
  </tr>
  <tr>
    <td><input type="text" id="fname" name="a4" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m4" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a5" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m5" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a6" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m6" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a7" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m7" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a8" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m8" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a9" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m9" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a10" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m10" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a11" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m11" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a12" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m12" placeholder="quantité"></td>
    
</tr>

<tr>
    <td><input type="text" id="fname" name="a13" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m13" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a16" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m16" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a17" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m17" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a18" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m18" placeholder="quantité"></td>
    
</tr>
<!---->
<tr>
    <td><input type="text" id="fname" name="a19" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m19" placeholder="quantité"></td>
    
</tr>

<tr>
    <td><input type="text" id="fname" name="a20" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m20" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a21" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m21" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a22" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m22" placeholder="quantité"></td>
    
</tr>
<!---->
<tr>
    <td><input type="text" id="fname" name="a23" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m23" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a24" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m24" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a25" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m25" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a26" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m26" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a27" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m27" placeholder="quantité"></td>
    
</tr>
<!-- part two -->
<tr>
    <td><input type="text" id="fname" name="a28" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m28" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a29" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m29" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a30" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m30" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a31" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m31" placeholder="quantité"></td>
    
</tr>
<tr>
    <td><input type="text" id="fname" name="a32" placeholder="reference"></td>
    <td><input type="text" id="fname" name="m32" placeholder="quantité"></td>
    
</tr>
</table>
<button class="button" formaction="client.php">Vérifier</button>

  <button class="button" formaction="clientfinal.php" target="_blank">Check Paayment</button>
  <button class="button" formaction="remisequantite.php" target="_blank">Remise quantité</button>
 <!-- <h2>remise client</h2>
<input type="text" id="fname" name="a14" placeholder="remise client fidéle">
-->
  <h2>Remise quantité</h2>
<input type="text" id="fname" name="a15" placeholder="remise Quantité">
